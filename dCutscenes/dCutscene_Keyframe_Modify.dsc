          ...
          - if <[arg]> != null:
            ...
            - choose <[arg]>:
              ...
              - case record_camera_duration_chat:
                - define text "Chat the duration the camera will record your movement."
                - narrate "<element[DCutscenes].color_gradient[from=blue;to=aqua].bold> <gray><[text]>"
              ...
              - case record_camera_begin:
                ...
                - wait 1s
                - adjust <player> gamemode:spectator
                - narrate "<element[DCutscenes].color_gradient[from=blue;to=aqua].bold> <gray>Recording has begun."
                #l = location
                #e = eye_location
                - repeat <[duration].in_ticks> as:tick-i:
                  ...
                  - wait 1t
                #=-Debugger
                - if <script[dcutscenes_config].data_key[config].get[cutscene_tool_debugger_mode]||false.is_truthy>:
                ...
                - flag server dcutscenes.<[data.name]>.keyframes.camera:<[camera_data]>
                - flag <player> cutscene_data:<server.flag[dcutscenes.<[data.name]>]>
                - define text "Camera recording is finished and has been set to tick <green><[tick]>t <gray>for scene <green><[data.name]><gray>."
                - narrate "<element[DCutscenes].color_gradient[from=blue;to=aqua].bold> <gray><[text]>"
                - adjust <player> gamemode:creative
                - inventory open d:dcutscene_inventory_keyframe_modify_camera

              #Move camera animator to new keyframe prep
              - case move_camera_prep:
                - define tick <player.flag[dcutscene_tick_modify]>
                - define camera <[camera_data.<[tick]>]>
                - definemap move_data animator:camera type:move tick:<[tick]> data:<[camera]>
              ...
              #Duplicate camera to a new keyframe prep
              - case duplicate_camera_prep:
                - define tick <player.flag[dcutscene_tick_modify]>
                - define camera <[camera_data.<[tick]>]>
                - definemap dup_data animator:camera type:duplicate tick:<[tick]> data:<[camera]>
          ...
          - else:
            - choose <[arg]>:
              ...
              - case move_to_prep:
                ...
                - definemap move_data animator:player_model type:move tick:<[tick]> uuid:<[uuid]> data:<[player_model_data]>
                - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
              ...
              - case duplicate_prep:
                ...
                - define uuid <player.flag[dcutscene_tick_modify.uuid]>
                - define player_model_data <[data.keyframes.models.<[tick]>.<[uuid]>]>
                - definemap dup_data animator:player_model type:duplicate tick:<[tick]> uuid:<[uuid]> data:<[player_model_data]>
                - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
                - define text "Click on the tick you'd like to duplicate this player model animator to. To stop chat <red>cancel<gray>."
                - narrate "<element[DCutscenes].color_gradient[from=blue;to=aqua].bold> <gray><[text]>"
                - ~run dcutscene_keyframe_modify def:back
          ...
          - choose <[arg]>:
            ...
            - case create:
              ...
              - if <[script_check]> != null:
                ...
                - define keyframes.run_task.<[tick]>.<[task_uuid]>:<[run_task_data]>
                #Input the data
            ...
            - case move_to_prep:
              ...
              - definemap move_data animator:run_task type:move tick:<[tick]> uuid:<[uuid]> data:<[run_task_data]>
              - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
            ...
            - case duplicate_prep:
              ...
              - define uuid <player.flag[dcutscene_tick_modify.uuid]>
              - define run_task_data <[keyframes.run_task.<[tick]>.<[uuid]>]>
              - definemap dup_data animator:run_task type:duplicate tick:<[tick]> uuid:<[uuid]> data:<[run_task_data]>
              - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
          ...
          - choose <[arg]>:
            ...
            - case create:
              ...
              - if <[fade_in]> != null && <[stay]> != null && <[fade_out]> != null:
                ...
                - define keyframes.screeneffect.<[tick]>:<[screeneffect_data]>
            ...
            - case move_to_prep:
              ...
              - definemap move_data animator:screeneffect type:move tick:<[tick]> data:<[screeneffect_data]>
              - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
            ...
            - case duplicate_prep:
              - define tick <player.flag[dcutscene_tick_modify.tick]>
              - define screeneffect_data <[keyframes.screeneffect.<[tick]>]>
              - definemap dup_data animator:screeneffect type:duplicate tick:<[tick]> data:<[screeneffect_data]>
              - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
        ...
        - case sound:
          - choose <[arg]>:
            ...
            - case create:
              ...
              - define keyframes.sound.<[tick]>.<[uuid]>:<[sound_data]>
              #Input the data
              - flag server dcutscenes.<[scene_name]>.keyframes.elements:<[keyframes]>
              - flag <player> cutscene_data:<server.flag[dcutscenes.<[scene_name]>]>
              - ~run dcutscene_sort_data def:<[scene_name]>
            ...
            - case move_to_prep:
              ...
              - definemap move_data animator:sound type:move tick:<[tick]> uuid:<[uuid]> data:<[sound_data]>
              - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
            ...
            - case duplicate_prep:
              ...
              - define uuid <player.flag[dcutscene_tick_modify.uuid]>
              - define sound_data <[keyframes.sound.<[tick]>.<[uuid]>]>
              - definemap dup_data animator:sound type:duplicate tick:<[tick]> uuid:<[uuid]> data:<[sound_data]>
              - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
              - define text "Click on the tick you'd like to duplicate this run task animator to. To stop chat <red>cancel<gray>."
              - narrate "<element[DCutscenes].color_gradient[from=blue;to=aqua].bold> <gray><[text]>"
              - ~run dcutscene_keyframe_modify def:back
        ...
        - case fake_object:
          - choose <[arg]>:
            ...
            - case move_to_fake_block_prep:
              ...
              - definemap move_data animator:fake_block type:move tick:<[tick]> uuid:<[uuid]> data:<[fake_block_data]>
              - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
            ...
            - case duplicate_fake_block_prep:
              ...
              - define uuid <player.flag[dcutscene_tick_modify.uuid]>
              - define fake_block_data <[keyframes.fake_object.fake_block.<[tick]>.<[uuid]>]>
              - definemap dup_data animator:fake_block type:duplicate tick:<[tick]> uuid:<[uuid]> data:<[fake_block_data]>
              - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
            ...
            - case move_to_fake_schem_prep:
              ...
              - definemap move_data animator:fake_schem type:move tick:<[tick]> uuid:<[uuid]> data:<[fake_schem_data]>
              - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
            ...
            - case duplicate_fake_schem_prep:
              ...
              - define uuid <player.flag[dcutscene_tick_modify.uuid]>
              - define fake_schem_data <[keyframes.fake_object.fake_schem.<[tick]>.<[uuid]>]>
              - definemap dup_data animator:fake_schem type:duplicate tick:<[tick]> uuid:<[uuid]> data:<[fake_schem_data]>
              - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
        ...
        - case particle:
          - choose <[arg]>:
            ...
            - case move_to_prep:
              ...
              - definemap move_data animator:particle type:move tick:<[tick]> uuid:<[uuid]> data:<[particle_data]>
              - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
            ...
            - case duplicate_prep:
              ...
              - define uuid <player.flag[dcutscene_tick_modify.uuid]>
              - define particle_data <[keyframes.particle.<[tick]>.<[uuid]>]>
              - definemap dup_data animator:particle type:duplicate tick:<[tick]> uuid:<[uuid]> data:<[particle_data]>
              - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
        ...
        - case title:
          - choose <[arg]>:
            ...
            - case move_to_prep:
              ...
              - definemap move_data animator:title type:move tick:<[tick]> data:<[title_data]>
              - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
            ...
            - case duplicate_prep:
              - define tick <player.flag[dcutscene_tick_modify]>
              - define title_data <[keyframes.title.<[tick]>]>
              - definemap dup_data animator:title type:duplicate tick:<[tick]> data:<[title_data]>
              - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
        ...
        - case command:
          - choose <[arg]>:
            ...
            - case move_to_prep:
              ...
              - definemap move_data animator:command type:move tick:<[tick]> uuid:<[uuid]> data:<[command_data]>
              - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
            ...
            - case duplicate_prep:
              ...
              - define uuid <player.flag[dcutscene_tick_modify.uuid]>
              - define command_data <[keyframes.command.<[tick]>.<[uuid]>]>
              - definemap dup_data animator:command type:duplicate tick:<[tick]> uuid:<[uuid]> data:<[command_data]>
              - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
              - define text "Click on the tick you'd like to move this command animator to. To stop chat <red>cancel<gray>."
              - narrate "<element[DCutscenes].color_gradient[from=blue;to=aqua].bold> <gray><[text]>"
              - ~run dcutscene_keyframe_modify def:back
        ...
        - case message:
          - choose <[arg]>:
            ...
            - case move_to_prep:
              ...
              - definemap move_data animator:message type:move tick:<[tick]> uuid:<[uuid]> data:<[message_data]>
              - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
            ...
            - case duplicate_prep:
              ...
              - define uuid <player.flag[dcutscene_tick_modify.uuid]>
              - define message_data <[keyframes.message.<[tick]>.<[uuid]>]>
              - definemap dup_data animator:message type:duplicate tick:<[tick]> uuid:<[uuid]> data:<[message_data]>
              - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
        ...
        - case time:
          - choose <[arg]>:
            ...
            - case move_to_prep:
              ...
              - definemap move_data animator:time type:move tick:<[tick]> data:<[time_data]>
              - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
            ...
            - case duplicate_prep:
              - define tick <player.flag[dcutscene_tick_modify]>
              - define time_data <[keyframes.time.<[tick]>]>
              - definemap dup_data animator:time type:duplicate tick:<[tick]> data:<[time_data]>
              - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
        ...
        - case weather:
          - choose <[arg]>:
            ...
            - case move_to_prep:
              ...
              - definemap move_data animator:weather type:move tick:<[tick]> data:<[weather_data]>
              - flag <player> dcutscene_animator_change:<[move_data]> expire:3m
            ...
            - case duplicate_prep:
              - define tick <player.flag[dcutscene_tick_modify]>
              - define weather_data <[keyframes.weather.<[tick]>]>
              - definemap dup_data animator:weather type:duplicate tick:<[tick]> data:<[weather_data]>
              - flag <player> dcutscene_animator_change:<[dup_data]> expire:3m
